...
import core.dataprep.siamese_generator as sg
import tensorflow.keras as keras
import matplotlib.pyplot as plt

data_dir='/work/datascience/'
train_generator = sg.SiameseDataGenerator(data_dir+'errantbeam_train_ftype00000000_nsamples10000_npeaks75_indexaligned_mediancuts_dtypef32_sept2020_v3.npy',
...
val_generator = sg.SiameseDataGenerator(data_dir+'errantbeam_val_ftype00000000_nsamples10000_npeaks75_indexaligned_mediancuts_dtypef32_sept2020_v3.npy',
...
with my_strategy.scope():
    model = sms.siameseModelWithResNet(UQ=False, num_filters=[16, 32, 64, 128],
                           strides=[2,2,2,2], CommonDense_nodes=[128], CommonDrop_percentage=[0.095], distanceMetric=distance_metric,
                           input_shape=(nsamples, 1), dropPercentage=drop_percentage, lambdaShift=lambda_shift, **{'activation':"sigmoid"})
